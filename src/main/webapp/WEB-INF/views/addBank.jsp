    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/SpringMvcBankMySql/addRes" method="post">
                        <!-- <div class="md-3">
                             <label>Bank Id</label>
                             <input type="number" name="bankId" placeholder="Enter Bank Id ....." class="form-control">
                        </div><br> -->
                        <div class="md-3">
                        ...
                        <div class="md-3">
                             ...
                             <input type="text" name="empName" placeholder="Enter Employee Name ....." class="form-control">
                        </div><br>
                        <div class="md-3">
                        ...
                        <div class="md-3">
                             <label>Salary</label>
                             <input type="number" name="salary" placeholder="Enter Salary ....." class="form-control">
                        </div><br>
                        <div class="md-3">
                             <label>Address</label>
